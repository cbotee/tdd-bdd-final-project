...
class TestProductRoutes(TestCase):
    ...
    def test_get_product(self):
        ...
        # Make a GET request to the API endpoint to retrieve the product
    ...
    def test_get_product_not_found(self):
        ...
        # Make a GET request to the API endpoint with wrong product id
        response = self.client.get(f"{BASE_URL}/0")
        # Assert that the return code was HTTP_404_NOT_FOUND
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        data = response.get_json()
        # Check the json that was returned and assert that it is equal to the data that you expect
